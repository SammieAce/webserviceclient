 ...
 * 
 */
@WebServiceClient(name = "TestWS", targetNamespace = "http://ws.psd.safaricom.com/", wsdlLocation = "http://saf.ngrok.io/TestWebService/TestWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://saf.ngrok.io/TestWebService/TestWS?wsdl");
